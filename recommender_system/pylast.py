...
class Network(object):
	...
	def __init__(self, name, homepage, ws_server, api_key, api_secret, session_key, submission_server, username, password_hash,
		...
		self.api_key = "993a5bd9d79a98a53677570368d55acd" # this is a sample key
		self.api_secret = "9b8de0b57903ac007cdd8ec9003b341e"
		self.session_key = session_key
		self.username = "pythonlab"
		self.password_hash = md5("pythonlab")
